...
It is recommended to use MS-Decipher of the latest version, which could be downloaded [here](https://github.com/dicp1809/MS-Decipher/releases), where previous version can also be acquired.
